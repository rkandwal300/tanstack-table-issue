    ...
    return (
      ...
      >
        <div ref={ref} className={cn('space-y-4', className)} {...props}>
          <div
            className={cn(
              'flex w-full flex-1 justify-between gap-2 text-center sm:flex-wrap',
    ...
    >
      ...
      >
        <Button
          ...
          //   onClick={onClickItem}
          className={cn(
            'stepper-item-button aspect-square h-8 w-8 rounded-full p-2.5',
        ...
        >
          <p className="text-xs text-slate-900 dark:text-slate-100 sm:text-sm">
            {steps[step].label}
          </p>
